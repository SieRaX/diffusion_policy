...
from diffusion_policy.policy.moh_diffusion_unet_hybrid_image_policy import MoHDiffusionUnetHybridImagePolicy
...
class TrainMoHUnetHybridWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: MoHDiffusionUnetHybridImagePolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: MoHDiffusionUnetHybridImagePolicy = None
    ...
    def run(self):
        ...
        if cfg.training.debug:
            ...
            cfg.task.env_runner.max_steps = cfg.task.env_runner.max_steps // 2
...
def main(cfg):
    workspace = TrainMoHUnetHybridWorkspace(cfg)
    workspace.run()

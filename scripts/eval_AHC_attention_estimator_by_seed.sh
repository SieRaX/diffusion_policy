...
do
    ...
    python eval_AHC_attention_estimator_by_seed.py --checkpoint outputs/lift_lowdim_ph_reproduction/2025.04.26_17.15.57_train_diffusion_unet_lowdim_lift_lowdim_cnn_32/checkpoints/epoch=0150-test_mean_score=1.000.ckpt --output_dir outputs/lift_lowdim_ph_reproduction/2025.04.26_17.15.57_train_diffusion_unet_lowdim_lift_lowdim_cnn_32/eval_AHC_disturbance_by_seed/eval_AHC_seed_${seed}_jumping_disturbance_num_distrub_1_pos_0.03_gripper_dir_near_gripper_0.025 --seed ${seed} --n_test_vis 5 --device cuda:0 --env_runner diffusion_policy.env_runner.robomimic_lowdim_AHC_jumping_disturbance_attention_estimator_runner_by_seed.RobomimicLowdimAHCRunner --max_steps 70
done
